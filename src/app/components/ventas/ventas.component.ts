...
showModal_Pagar():void{
  ...
  console.log('this.ventaForm.ps_falta:',this.ventaForm.ps_falta , 'this.ps_total - this.ventaForm.ps_falta:', Math.ceil((this.bs_total - totalPagadoEnBs) / this.tipo_de_cambio / 50) * 50); 
...
agregar_Producto(producto: any) {
  ...
  this.ventaForm.ps_total = Math.ceil(this.ventaForm.bs_total / this.tipo_de_cambio / 50) * 50;
  ...
  const complementosProducto = this.lista_Productos_Complementos
    ...
    this.lista_Productos_Agregados.push({
        ...
        ps_precio:Math.ceil(producto.precio / this.tipo_de_cambio / 50) * 50,
        cantidad_item: 1,
        item_llevar:false,
...
disminuir_cantidad(){
  ...
  producto.cantidad_item--;
  this.ventaForm.bs_total = this.ventaForm.bs_total - producto.precio;
  this.ventaForm.ps_total = Math.ceil(this.ventaForm.bs_total / this.tipo_de_cambio / 100) * 100;
  //TERCERO COPIAMOS A VENTA-FALTA
  this.ventaForm.bs_falta = this.ventaForm.bs_total; 
}
...
calcular_descuento() {
  ...
  if (bs_descuento > 0 && bs_descuento <= this.bs_total) {
    // Restablecer el descuento en pesos a 0
    this.ventaForm.ps_descuento = null;
    
    // Convertir el descuento en bolivianos a pesos argentinos
    ps_descuento = Math.ceil(bs_descuento / this.tipo_de_cambio / 50) * 50;
  ...
  // Si se ingresa un descuento en pesos argentinos, ignorar el de bolivianos y restaurarlo
    ...
    console.log('bs_descuento: ',ps_descuento * this.tipo_de_cambio);
    // bs_descuento = Math.round(ps_descuento * this.tipo_de_cambio);
    bs_descuento = Math.round((ps_descuento * this.tipo_de_cambio) * 2)  / 2;
...
actualizarFaltantesBolivianos(){
  ...
  let aux_bs_falta = Math.round((psTotal - psPagado) * tipoDeCambio) * 2 / 2;
  ...
  const psPagadoEnBs = (Math.round(psPagado * tipoDeCambio * 2) / 2) - (Math.round(psCambio * tipoDeCambio * 2) / 2);
  console.log('0.- ps_pagado_en_bs:', psPagadoEnBs, ' = ps_pagado:', (Math.round(psPagado * tipoDeCambio * 2) / 2), ' - psCambio:',(Math.round(psCambio * tipoDeCambio * 2) / 2));
  ...
  console.log('5.- this.ventaForm.ps_falta:', this.ventaForm.ps_falta, ' = this.ventaForm.bs_falta:', this.ventaForm.bs_falta, ' / tipo_de_cambio:', tipoDeCambio);
  ...
  console.log('*************************************************************************');
  console.log('FIN DE LA FUNCION actualizarFaltantes()');
  console.log('*************************************************************************');
}
...
actualizarFaltantesArgentinos(){
  ...
  const aux_ps_cambio = psPagado - aux_ps_falta; console.log('aux_ps_cambio: ', aux_ps_cambio);
  ...
  const totalPagadoEnPs = psPagado + (Math.ceil(bsPagado / tipoDeCambio / 50) * 50) + (Math.ceil(bsBancaPagado / tipoDeCambio / 50) * 50) - (Math.ceil(bsCambio / tipoDeCambio / 50) * 50);
  console.log('6.- totalPagadoEnPs:', totalPagadoEnPs, ' = ps_pagado:', psPagado, ' + bs_pagado / tipo_de_cambio:', (Math.ceil(bsPagado / tipoDeCambio / 50) * 50), ' + bs_banca_pagado / tipo_de_cambio:', (Math.ceil(bsBancaPagado / tipoDeCambio / 50) * 50), ' - bsCambio: ',(Math.ceil(bsCambio / tipoDeCambio / 50) * 50));
  ...
  console.log('13.- Math.ceil((this.ventaForm.ps_falta * tipo_de_cambio) * 2):', Math.round((this.ventaForm.ps_falta * tipoDeCambio) * 2), ' / 2:', this.ventaForm.bs_falta);
