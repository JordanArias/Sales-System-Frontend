...
producto = {cod_producto:0 , nombre:'' , precio:null as number|null , producto_unico:0 , estado:0 , cocina:false, cod_categoria:null as number|null , cod_subcategoria:null as number|null};
...
limpiar_Datos(){
  this.producto = {cod_producto:0 , nombre:'' , precio:null as number|null , producto_unico:0 , estado:0 , cocina:false, cod_categoria:null as number|null , cod_subcategoria:null as number|null};
...
isFormValid(): boolean {
  ...
  return this.producto.nombre.trim().length > 0  && this.producto.precio != null && this.producto.precio > 0 && existe_insumo;
}
