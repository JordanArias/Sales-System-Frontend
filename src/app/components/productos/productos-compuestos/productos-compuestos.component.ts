...
productoForm = {cod_producto:0 , nombre:'' , precio:null as number|null , producto_unico:1 , estado:0 , cocina:false, cod_categoria:null as number|null , cod_subcategoria:null as number|null};
...
limpiar_Datos(){
  this.productoForm = {cod_producto:0 , nombre:'' , precio:null as number|null , producto_unico:1 , estado:0 , cocina:false, cod_categoria:null as number|null , cod_subcategoria:null as number|null};
